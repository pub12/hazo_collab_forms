 ...
 * Documents the HazoCollabFormRadio component
 */
...
import { HazoCollabFormRadio } from 'hazo_collab_forms';

/**
 * Radio Component test page
 */
export default function RadioComponentPage() {
  const config = COMPONENT_PAGES.find(c => c.path === '/components/radio');
  ...
  const base_props: PropsTableData[] = [
    { name: 'label', type: 'string', required: true, category: 'Input Field', description: 'Label text for the field', is_inherited: true, default_value: 'Sample Radio Field' },
  ...
  const radio_props: PropsTableData[] = [
    {
      name: 'options',
      type: 'RadioOption[]',
      required: true,
      category: 'Input Field',
      description: 'Array of radio options. Each option has value, label, and optional disabled properties',
    },
    {
      name: 'value',
      type: 'string',
    ...
    {
      name: 'radio_wrapper_class_name',
      type: 'string | undefined',
      required: false,
      category: 'Controllable Element',
      description: 'Custom className for the radio wrapper',
    },
    {
      name: 'radio_option_wrapper_class_name',
      type: 'string | undefined',
      required: false,
      category: 'Controllable Element',
      description: 'Custom className for individual radio option wrapper',
    },
    {
      name: 'layout',
      ...
      required: false,
      category: 'Controllable Element',
      description: 'Layout direction for radio options. "vertical" (default) or "horizontal"',
    },
    {
      name: 'disabled',
  ...
  const props_table_data = [...base_props, ...radio_props];
  ...
  const example_component = (prop_values: Record<string, any>) => {
    ...
    const component_props: Record<string, any> = {
      ...
      label: prop_values.label || 'Sample Radio Field',
    ...
    if (prop_values.layout !== undefined && prop_values.layout !== '') {
      component_props.layout = prop_values.layout;
    }
    ...
    return (
      <div className="cls_radio_example_container space-y-4">
        <HazoCollabFormRadio
